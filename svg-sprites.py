...
g.add(grf.ReplaceOldSprites(((3090, 2),)))
g.add(SVGSprite((SVGFile('base/3090_flag_stopped.svg'),), 7, 8, 0, 0))
g.add(SVGSprite((SVGFile('base/3091_flag_running.svg'),), 7, 8, 0, 0))
